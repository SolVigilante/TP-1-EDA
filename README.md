...
Como en nuestro programa no multiplicamos y luego dividimos por la masa del planeta en el análisis de fuerzas entonces la precision de float nos resulta suficiente. En el caso de que hicieramos eso, deberíamos utilizar una presicion de double o hasta incluso de long double.
